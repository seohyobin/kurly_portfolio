...
<div id='login'>
	<div class='container'>
		...
		<div class="content">
		    <form name="idCheckForm" autocomplete="off" id="idCheckForm" method="post" action="./idCheckAction.jsp">
		        <ul>
		            <li><input  maxlength="30" type="text" name="user_id" id="userId" placeholder="아이디를 입력하세요"></li>		           
		        </ul>
